data:extend
{
  ...
  },
  {
    ...
    icon = "__More_Train_Control_Signals__/refuel-icon.png",
    icon_size = 64,
    icon_mipmaps = 1,
  ...
  },
  {
    ...
    icon = "__More_Train_Control_Signals__/depot-icon.png",
    icon_size = 64,
    icon_mipmaps = 1,
    subgroup = "train-control-signals",
    order = "ba"
  },
  {
    ...
    icon = "__More_Train_Control_Signals__/skip-icon.png",
    icon_size = 64,
    icon_mipmaps = 1,
    subgroup = "train-control-signals",
    order = "ca"
  },
  {
    ...
    icons = {
      ...
      {
        icon = "__More_Train_Control_Signals__/load-icon.png",
      }
    },
    icon_size = 64,
    icon_mipmaps = 1,
  ...
  },
  {
    ...
    icons = {
      ...
      {
        icon = "__More_Train_Control_Signals__/unload-icon.png",
      }
    }, 
    icon_size = 64,
    icon_mipmaps = 1,
  ...
  },
  {
    ...
    icon = "__More_Train_Control_Signals__/priority-icon.png",
    icon_size = 64,
    icon_mipmaps = 1,
    subgroup = "train-control-signals",
    order = "fa"
  },
  {
    ...
    icon = "__More_Train_Control_Signals__/optional-icon.png", 
    icon_size = 64,
    icon_mipmaps = 1,
    subgroup = "train-control-signals",
    order = "ga"
